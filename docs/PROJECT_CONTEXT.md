...
| PTC specific cost | $300/m² at 1000 m² (scale exponent 0.80) |
| PTC BOP factor | 1.40 |
| Tank vessel | SS316, ASME VIII-1 (t_design = 45 mm at 5 bar) |
| Tank EPC factor | 3.5× material cost |
| HTF price | $1.00/kg (mid-scale industrial) |
| HX costs | Turton et al. (2018) floating-head SS316/SS316 |
| Pump costs | $10,800 × W^0.62 (Turton + CSP premium) |
| Piping | 10% of direct equipment |
| EPC overhead | 25% of total direct cost |
| Electricity (Chile industrial) | $0.17/kWh |
| Natural gas (Chile industrial) | $0.06/kWh_th |
| O&M | 2% CAPEX/year |
| Full methodology | `insumos paper/ECONOMIC_METHODOLOGY.md` |
| Bibliography | `insumos paper/references.bib` |
