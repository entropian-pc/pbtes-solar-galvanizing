...
class ExergoeconomicAssessment(EconomicAssessment):
    ...
    def run_exergoeconomic_assessment(self) -> Dict[str, float]:
        ...
        # Values are in kJ; convert to J for exergy calculation
        Ex_aux_J = (Q_aux_proc + Q_aux_tes) * 1000.0
        ...
        Q_delivered_total_J = (Q_solar_to_proc + Q_tes_to_proc + Q_aux_proc) * 1000.0
