...
class ThermalEnergyStorage:
    ...
    def eq_params(self, T_in, mass_flow):
        ...
        Nu = 2.0 + 1.1 * Re**0.6 * Pr**(1.0/3.0)  # Wakao-Kaguei (1979); +2.0 conduction asymptote critical at low Re
        h_sf = Nu * self.k_f / self.dp  # W/m2 K - particle-to-fluid surface HTC
        hv = ff * h_sf  # W/m3 K - volumetric heat transfer coeff
    ...
    def calc_heat_loss(self, profile, dt, T_amb, T_set=None):
        ...
        self.last_total_heat_loss_J = total_heat_loss_J
